...
DO NOT add explanations, markdown, or extra text or 
...
respose = client.models.generate_content(
    model='gemini-2.5-flash',
    config=types.GenerateContentConfig(
        system_instruction=f"You are a helpful assitant for made to find and make improvement in resume for engineers" # Overall role
    ),
